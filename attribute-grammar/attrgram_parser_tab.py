...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','parser.py',26),
  ('statement -> expression','statement',1,'p_statement_expr','parser.py',30),
  ...
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','parser.py',48),
  ('expression -> NUMBER','expression',1,'p_expression_number','parser.py',52),
  ('expression -> NAME','expression',1,'p_expression_name','parser.py',56),
]
